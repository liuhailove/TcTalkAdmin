<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="small" class="btn-add" @click="handleAdd()">秒杀活动时间段列表</el-button>
    </el-card>
...
const handleAdd = () => {
  router.push({path: '/marketing/flash/promotion/add'})
}

const handleUpdate = (row) => {
  router.push({path: '/marketing/flash/promotion/update', query: {id: row.id}})
}
