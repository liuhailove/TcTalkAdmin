<template>
  <div class="app-container">
        ...
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="https://github.com/liuhailove/gmiter" target="_blank">TCTalk学习教程</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="https://github.com/liuhailove/gmiter" target="_blank">TCTalk视频教程（2023）</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="https://github.com/liuhailove/gmiter" target="_blank">TCTalk项目</a>
            </div>
          </div>
        </el-col>
      </el-row>
    ...
    <el-card class="mine-layout">
      ...
      <div style="text-align: center">TCTalk全套学习教程连载中！</div>
...
import {str2Date} from '@/utils/date.ts';
...
const getData = () => {
  setTimeout(() => {
    ...
    for (let i = 0; i < DATA_FROM_BACKEND.rows.length; i++) {
      ...
      let currDate = str2Date(item.date, null);
      let orderCountDateArr = orderCountDate.value;
      let start = orderCountDateArr[0];
      let end = orderCountDateArr[1];
      if (currDate.getTime() >= start.getTime() && currDate.getTime() <= end.getTime()) {
        chartData.value.rows.push(item);
      }
    }
